                ...
                <div className="text-center mb-6">
                  ...
                  >
                    <div className="relative">
                      <div className={`absolute inset-0 bg-gradient-to-r ${badgeGradientCSS} rounded-full blur-md opacity-60`}></div>
                      <span className={`relative text-xs font-semibold text-white px-6 py-2.5 rounded-full bg-gradient-to-r ${badgeGradientCSS} shadow-xl border border-white/20 backdrop-blur-sm tracking-wide`}>
                        ESPECIALIDADES
                      </span>
                    </div>
                  </motion.div>
